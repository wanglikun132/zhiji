 ...
 */
@Service
public class DongMoService implements CalculationStrategyService, InitializingBean {
	@Override
	...
	public void countTotalCost(List<Object> list, CountCosmeticsBeen countCosmeticsBeen) {
        ...
        countCosmeticsBeen.setRNWDongMoCost(MathUtils.getBigDecimal(totalPrice));
	}

	@Override
	public void countTotalPromotion(List<Object> list, CountCosmeticsBeen countCosmeticsBeen) {
        Object totalPrice = list.get(12);
        countCosmeticsBeen.setRNWDongMoPromotion(MathUtils.getBigDecimal(totalPrice));
	}

	@Override
	public void countTotalSample(List<Object> list, CountCosmeticsBeen countCosmeticsBeen) {
        Object totalPrice = list.get(12);
        countCosmeticsBeen.setRNWDongMoSample(MathUtils.getBigDecimal(totalPrice));
	}
